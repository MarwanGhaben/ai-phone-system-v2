...
REQUIRED_SENTINELS = {
    ...
    "migrations/0004_appointment_notifications.sql": b"T049_REQUIRED_NOTIFICATION_SQL",
    "services/scheduling/removal_reconciliation.py": b"T049_REQUIRED_RECONCILIATION_SOURCE",
    "services/calendar/provider_admission.py": b"T049_REQUIRED_PROVIDER_ADMISSION_SOURCE",
    "services/sms/notification_outbox.py": b"T049_REQUIRED_OUTBOX_SOURCE",
    "services/sms/notification_worker.py": b"T049_REQUIRED_WORKER_SOURCE",
    "services/sms/telnyx_submission.py": b"T049_REQUIRED_SUBMISSION_SOURCE",
