...
CATEGORIES = {
    ...
    'memory_failure': r'out of memory|cannot allocate memory|"OOMKilled"\s*:\s*true',
    'docker_network_error': r'Error response from daemon:.*network.*(?:active endpoints|in use)|invalid pool request|address pools',
